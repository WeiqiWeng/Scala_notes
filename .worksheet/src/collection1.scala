...
*/
object collection1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(277); 
  //1. List
  // First we introduce some predefined operators.
	...
	mergeSortOrdering[String](chars);System.out.println("""res10: List[String] = """ + $show(res$10));$skip(181); val res$11 = 
	...
	chars sortWith (_.length < _.length);System.out.println("""res11: List[String] = """ + $show(res$11));$skip(14); val res$12 = 
	chars.sorted;System.out.println("""res12: List[String] = """ + $show(res$12));$skip(138); val res$13 = 
	
	// Another Scala featured method is groupBy. It takes a condition to group the elements and
	// returns a map.
	chars groupBy (_.head);System.out.println("""res13: scala.collection.immutable.Map[Char,List[String]] = """ + $show(res$13));$skip(163); 
	...
	def sqList(l: List[Int]): List[Int] = {
		l map (x => x * x)
	};System.out.println("""sqList: (l: List[Int])List[Int]""");$skip(14); val res$14 = 
	
	sqList(l1);System.out.println("""res14: List[Int] = """ + $show(res$14));$skip(170); 
	
	//filter will pick out the elements satisfying given condition
	//filterNot is similar
	def biggerThan(l: List[Int], n: Int): List[Int] = {
		l filter (x => x > n)
	};System.out.println("""biggerThan: (l: List[Int], n: Int)List[Int]""");$skip(21); val res$15 = 
	
	biggerThan(l1, 3);System.out.println("""res15: List[Int] = """ + $show(res$15));$skip(95); val res$16 = 
	// combining filter and filterNot into a pair we may get partition
	l1 partition (x => x > 3);System.out.println("""res16: (List[Int], List[Int]) = """ + $show(res$16));$skip(294); val res$17 = 
	...
	l1 takeWhile (x => x < 5);System.out.println("""res17: List[Int] = """ + $show(res$17));$skip(241); 
	...
	val data = List("a", "a", "a", "b", "b", "c", "c", "d", "a");System.out.println("""data  : List[String] = """ + $show(data ));$skip(22); val res$18 = 
	encode[String](data);System.out.println("""res18: List[(String, Int)] = """ + $show(res$18));$skip(22); val res$19 = 
	
	pack[String](data);System.out.println("""res19: List[List[String]] = """ + $show(res$19));$skip(122); 
	
	// Another important higher-order function is reduce.
	def sum(l: List[Int]): Int = {
		(0 :: l) reduceLeft (_ + _)
	};System.out.println("""sum: (l: List[Int])Int""");$skip(9); val res$20 = 
	sum(l1);System.out.println("""res20: Int = """ + $show(res$20));$skip(312); 
	...
	def sum1(l: List[Int]): Int = {
		(l foldLeft 0)(_ + _)
	};System.out.println("""sum1: (l: List[Int])Int""");$skip(10); val res$21 = 
	sum1(l1);System.out.println("""res21: Int = """ + $show(res$21));$skip(948); 
	...
	*/
	...
	val v1 = Vector(1, 2, 3);System.out.println("""v1  : scala.collection.immutable.Vector[Int] = """ + $show(v1 ));$skip(9); val res$22 = 
	v1 :+ 2;System.out.println("""res22: scala.collection.immutable.Vector[Int] = """ + $show(res$22));$skip(9); val res$23 = 
	2 +: v1;System.out.println("""res23: scala.collection.immutable.Vector[Int] = """ + $show(res$23));$skip(623); val res$24 = 
	...
	*/
	...
	1 to 5;System.out.println("""res24: scala.collection.immutable.Range.Inclusive = """ + $show(res$24));$skip(30); val res$25 =   // to inclusive
	1 until 5;System.out.println("""res25: scala.collection.immutable.Range = """ + $show(res$25));$skip(14); val res$26 =  // until exclusive
	1 to 10 by 2;System.out.println("""res26: scala.collection.immutable.Range = """ + $show(res$26));$skip(170); val res$27 = 
	...
	*/
	...
	l1 exists (x => x > 3);System.out.println("""res27: Boolean = """ + $show(res$27));$skip(24); val res$28 = 
	l1 forall (x => x > 3);System.out.println("""res28: Boolean = """ + $show(res$28));$skip(74); 
	...
	val (ll, lr) = lzip.unzip;System.out.println("""ll  : List[Int] = """ + $show(ll ));System.out.println("""lr  : List[Int] = """ + $show(lr ));$skip(96); val res$29 = 
	// map each element and concatenate into one single collection
	l1 flatMap (x => List(x, x+1));System.out.println("""res29: List[Int] = """ + $show(res$29));$skip(196); 
	...
	};System.out.println("""comb: (n: Int, m: Int)scala.collection.immutable.IndexedSeq[(Int, Int)]""");$skip(12); val res$30 = 
	comb(5, 4);System.out.println("""res30: scala.collection.immutable.IndexedSeq[(Int, Int)] = """ + $show(res$30));$skip(388); 
  ...
  val ld = List(1.0,2.0);System.out.println("""ld  : List[Double] = """ + $show(ld ));$skip(20); val res$31 = 
  innerProd(ld, ld);System.out.println("""res31: Double = """ + $show(res$31));$skip(181); 
  ...
  };System.out.println("""innerProd1: (xs: List[Double], ys: List[Double])Double""");$skip(22); val res$32 = 
	
	innerProd1(ld, ld);System.out.println("""res32: Double = """ + $show(res$32))}
